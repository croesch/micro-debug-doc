...
Mit dem Befehl \texttt{step} führen wir die nächste Assembler-Instruktion aus. In \lstref{tutorial-step-trace-mic} ist die Ausgabe dieses Befehls zu sehen -- da wir den Mikro-Assembler-Code noch beobachten ist diese Ausgabe unübersichtlich. Wir können aber in \lstref{tutorial-step-trace-mic-varwrite} sehen, dass die lokale Variable \texttt{0} den korrekten Wert erhalten hat.
...
Local variable 0: 49(*@\lstlbl{tutorial-step-trace-mic-varwrite}@*)
