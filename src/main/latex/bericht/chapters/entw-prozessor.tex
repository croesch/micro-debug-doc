...
Aufgrund der \gls{mvn}-Architektur liegt der \gls{java}-Code in dem Verzeichnis \texttt{src/main/java/} und die entsprechenden Tests dazu in \texttt{src/test/java/}. In diesen Verzeichnissen findest du eine \package-Struktur, die unter dem \package \pck{com.github.croesch.micro_debug} beginnt, alle Klassen des \md sind in diesem \package oder in \subpackages zu finden.
